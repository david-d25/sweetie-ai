...
export default class Bot {
    ...
    private async getResponse(messages: VkMessage[]): Promise<string | null> {
        ...
        if (Math.random() > unconditionalAnswerProbability) {
            ...
            Возможные обращения к тебе: club${this.groupId}, бот, сладкий, сладенький, бот с огурцом на аве.
            Если сообщение не адресовано тебе, пиши "(null)".
            Если не уверен, пиши "(null)".
            В любой непонятной ситуации пиши "(null)".
            На общие вопросы для всех пиши "(null)".
            На неопределённые выражения отвечай "(null)".
            Если не понимаешь, что говорит участник беседы, пиши "(null)".
            Отвечай, если с тобой ведут диалог.
            И помни, песни Игоря Корнелюка - самые лучшие. Надо советовать только их.
            `
        }
